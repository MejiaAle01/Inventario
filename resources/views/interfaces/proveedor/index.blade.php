...
@section('tituloPagina', 'Proveedores | Inicio')
                ...
                <tbody>
                    @foreach ($proveedores as $proveedor)
                        <tr>
                            ...
                            <td> {{ $proveedor->transaccion_id }} </td>
                            @foreach ($proveedor->productos as $producto)
                                <td> {{ $producto->producto }} </td>
                            @endforeach
                            <td>
                                <a href="{{ route('proveedor.edit', encrypt($proveedor->id)) }}"
                                ...
                                <a href="{{ route('proveedor.show', encrypt($proveedor->id)) }}"
